...
def prepare_training_images(resolution: int, in_folder: str, out_folder: str) -> 'tuple[int, list[str]]':
...
def prepare_testing_images(resolution: int, in_folder: str, out_folder: str) -> 'tuple[int, list[str]]':
